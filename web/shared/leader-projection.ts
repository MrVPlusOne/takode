...
function applyJourneyLifecyclePresentation(records: SessionAttentionRecord[]): SessionAttentionRecord[] {
  const startsByQuest = new Map<string, SessionAttentionRecord[]>();
