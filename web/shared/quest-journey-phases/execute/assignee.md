...
Deliverable:
- Add or refresh the Execute note, then return a compact outcome, the feedback index, and any urgent deviation, blocker, safety fact, or follow-up need. Keep monitor details, evidence, artifacts, cleanup, and residual risks in the phase note, then stop.
