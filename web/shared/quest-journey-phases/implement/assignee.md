...
Deliverable:
- Add or refresh the Implement note, then report only the feedback index, high-level outcome, commit if one was created, and any urgent blocker or safety fact. Keep detailed change rationale, verification, risks, and handoff facts in the phase note, then stop.
