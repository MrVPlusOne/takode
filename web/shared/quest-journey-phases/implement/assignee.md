...
- Add or refresh the consolidated quest summary comment when instructed. For long multi-topic summaries, write the full comment first and add `--tldr` metadata that preserves the major topics.
