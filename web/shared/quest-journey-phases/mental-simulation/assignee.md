...
Deliverable:
- Add or refresh the Mental Simulation note, then return a compact judgment, the feedback index, and any urgent recommendation or blocker. Keep scenarios, concrete examples, risks, and confidence limits in the phase note, then stop.
