...
Deliverable:
- Add or refresh the Outcome Review note, then return only ACCEPT or the concrete insufficiency, the feedback index, and any urgent routing blocker. Keep evidence assessment, bounded reruns, residual risks, and follow-up routing detail in the phase note, then stop.
