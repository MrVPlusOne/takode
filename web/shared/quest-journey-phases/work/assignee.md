...
- Recovery preserves the full remaining authorized Work envelope. After a system, transport, or leader-recovery interruption, reconstruct the latest durable state, verify rather than repeat completed side effects, and continue every still-authorized responsibility without waiting for leader-approved micro-handoffs. A status request is an update, not an implicit pause: answer concisely and continue unless scope or authority explicitly changed or a genuine safety/checkpoint boundary is reached.
