...
- The final Work note should record the delivered behavior or artifact, key design choices, important evidence, sync/push/external state, verification categories, checkpoint decisions, residual risks, and exact Memory handoff facts.
