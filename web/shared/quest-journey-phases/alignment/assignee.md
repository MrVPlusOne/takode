...
- If the assignment, quest, or post-compaction recovery context points to relevant file-based memory, run `memory recall "<quest or task terms>"` visibly and mention any memory files that materially affected the read-in.
