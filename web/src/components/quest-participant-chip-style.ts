...
export const QUEST_PARTICIPANT_ROLE_CLASS = "hidden shrink-0 text-cc-muted/75 sm:inline";
export const QUEST_PARTICIPANT_SESSION_CLASS = "shrink-0 font-mono-code text-amber-300";
