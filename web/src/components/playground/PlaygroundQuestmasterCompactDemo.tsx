        ...
        quests: [
          {
            ...
            questId: "q-901",
            version: 3,
            title: "Completed review checks use their column",
            status: "done" as const,
            description: "Keep User review checks visible without Status saying Inbox.",
            tldr: "Completed row references [q-986](quest:q-986) and keeps User review checks separated from Status, even when this TLDR wraps across authoring lines.",
