...
function PlaygroundActiveReasoningChipStates() {
  useEffect(() => {
    const now = Date.now();
    const sessionIds = [
    ...
    useStore.setState((state) => {
      ...
      activeCodexReasoningPreviews.set("playground-active-reasoning-long", {
        text: "Comparing the active turn route, browser-selected thread, and Codex reasoning stream so the preview stays scoped to the turn that is actually running.",
        updatedAt: now,
        threadKey: "q-42",
        questId: "q-42",
      });
  ...
  const states = [
    ...
    { label: "Short", sessionId: "playground-active-reasoning-short", currentThreadKey: "q-42" },
    { label: "Long", sessionId: "playground-active-reasoning-long", currentThreadKey: "q-42" },
    { label: "Updating", sessionId: "playground-active-reasoning-updating", currentThreadKey: "q-42" },
  ];
...
export function PlaygroundInteractiveSections() {
  ...
  return (
    <PlaygroundSectionGroup groupId="interactive">
      ...
      >
        <div className="max-w-3xl">
          ...
          <Card label="needs-input custom answer recording state">
            <div className="text-cc-fg text-sm">
              <p className="mb-1">The answer field is actively listening.</p>
      ...
      <PlaygroundQuestDetailModalSection />
