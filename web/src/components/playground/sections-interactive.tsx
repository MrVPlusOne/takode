...
function PlaygroundQuestStatusPanelDemo({ variant }: { variant: "claimed" | "board-attention" }) {
                ...
                onClick={() => {
                  ...
                  state.setSessionAttentionRecords(boardSessionId, [
                    ...
                    },
                    {
                      ...
                      questId: "q-88",
                      threadKey: "q-88",
                      title: "q-88 ready for review",
                      summary: "Completed work is available in the review inbox.",
                      actionLabel: "Review",
                      priority: "review",
                      state: "unresolved",
