          ...
          while (Date.now() - start < maxWait) {
            ...
            if (info && (info.state === "connected" || info.state === "running")) {
              wsBridge.injectUserMessage(session.sessionId,
                ...
                `When speaking directly to the human, start a line with \`@to(user):\`. Messages without this tag are treated as internal coordination activity in the Companion UI.\n\n` +
