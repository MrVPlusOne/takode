...
Legacy `outcome` fields from the retired editable-Outcome experiment are preserved as opaque read-only recovery data. Do not promote, rewrite, or delete them during Memory, and do not treat them as final-debrief authority. Final debrief metadata remains the quest-owned completion summary.
