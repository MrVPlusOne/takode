...
Do not treat an official repo doc, skill, or quest note as automatic proof that memory is unnecessary. If a lesson is cross-quest, likely to prevent repeat mistakes, or explains why an instruction surface was chosen, either capture a concise memory decision/pointer or explicitly defer memory writing to Bookkeeping/curation when the current phase does not own it.
