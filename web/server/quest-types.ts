...
interface QuestBase {
  ...
  /**
   * Opaque legacy payload from the rejected quest-owned Outcome model.
   * Preserve exactly across mutations, but never promote it into active UI, search,
   * completion, debrief, or leader-message authority.
   */
  outcome?: unknown;
