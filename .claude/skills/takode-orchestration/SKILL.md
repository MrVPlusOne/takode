...
- **Never skip quest journey stages.** Every quest gets the full lifecycle: PLANNING → SKEPTIC_REVIEWING → GROOM_REVIEWING → PORTING. No exceptions for "small" changes.
