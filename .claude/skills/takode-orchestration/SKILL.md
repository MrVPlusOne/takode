...
- **Leaders do not become the quest owner for Work.** The worker doing the job claims and completes the quest; the leader dispatches, answers real blockers, and handles genuine User Checkpoints.
