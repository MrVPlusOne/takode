...
- **Worker alignment returns a lightweight read-in inside a leader-authorized Journey.** It may surface blockers, surprises, and evidence that justify leader-owned Journey revision, but the board-owned Journey remains authoritative until the leader changes it.
