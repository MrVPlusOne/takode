...
- Canonical next phase depends on the explicit Journey plan, not on a fixed skeptic-review step

Do not use `quest-journey-implementation` as the primary workflow language in new prompts or docs.
