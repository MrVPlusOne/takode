...
- The canonical model no longer treats reviewer-groom as a separate default phase

Do not use `quest-journey-reviewer-groom` as primary workflow guidance in new prompts or docs.
