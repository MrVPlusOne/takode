...
- Zero-tracked-change quests should omit `port` from their explicit Journey plan instead of using a separate no-code port shortcut

Do not use `quest-journey-porting` as primary workflow guidance in new prompts or docs.
